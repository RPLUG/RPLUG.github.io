...
This research focuses on scalable numerical methods for particle-fluid systems. It connects resolved complex-particle mechanics with coarse-grained approaches so that simulations can be selected according to the physical scale and computational budget of each application.
...
- Coarse-grained gas-solid modelling with CG-DPM and MP-PIC for fluidized beds and conveying systems.
